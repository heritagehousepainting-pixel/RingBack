...
- [x] **S2 PLAN-AUDIT** (sonnet) → DONE. **GO-WITH-FIXES**. Web-verified HCP API → caught material
      errors (OAuth URLs, Bearer not Token, page_size/next_page_url, `description` not `note`, jobs have
